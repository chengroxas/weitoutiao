  ...
  <div class="admin-content">
    <div class="admin-content-body">
      <div class="am-cf am-padding am-padding-bottom-0">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">轮播的文章</strong> / <small>Table</small></div>
      </div>
          ...
          <form class="am-form">
            <table class="am-table am-table-striped am-table-hover table-main am-table-bordered">
              ...
              <tr>
                 ...
                 <th class="table-id">文章ID</th>
                 <th class="table-id">排列顺序</th>
			  ...
			  <?php if(is_array($data)): foreach($data as $key=>$log): ?><tr>
                ...
                <td><?php echo ($log['articleid']); ?></td>
                <td><?php echo ($log['no']); ?></td>				
				<td><img class="am-center" src="<?php echo ($log['loopimg']); ?>" /></td>                
                ...
                <td>
                  <div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                      <a href="<?php echo U('Article/editLoop',array('id'=>$log['id']));?>" class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span> 编辑</a>
                      <a href="<?php echo U('Article/loopDelete',array('id'=>$log['id']));?>" class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only"><span class="am-icon-trash-o"></span> 删除</a>
                    </div>
                  </div>
                </td>
