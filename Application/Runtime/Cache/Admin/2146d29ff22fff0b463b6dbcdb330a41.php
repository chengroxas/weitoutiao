      ...
      <ul class="am-list admin-sidebar-list">
        ...
        <li class="admin-parent">
          ...
          <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav">
			...
			<li><a href="<?php echo U('Type/index');?>" class="am-cf"><span class="am-icon-check"></span>文章管理<span class="am-icon-star am-fr am-margin-right admin-icon-yellow"></span></a></li>
			<li><a href="<?php echo U('Type/editArticle');?>" class="am-cf"><span class="am-icon-check"></span>文章管理列表<span class="am-icon-star am-fr am-margin-right admin-icon-yellow"></span></a></li>
                ...
                <td>
                  <div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                      ...
                      <a href="<?php echo U('Article/delete',array('id'=>$article['id']));?>"class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only"><span class="am-icon-trash-o"></span> 删除</a>
                    </div>
                  </div>
                </td>
