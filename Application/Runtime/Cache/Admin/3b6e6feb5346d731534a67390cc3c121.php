  ...
  <div class="admin-content">
    <div class="admin-content-body">
      <div class="am-cf am-padding am-padding-bottom-0">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">类型管理</strong> / <small>Table</small></div>
      </div>
        ...
        <div class="am-u-sm-12 am-u-md-6">
          <div class="am-btn-toolbar">
            <div class="am-btn-group am-btn-group-xs">
              <a href="<?php echo U('Type/editType',array('id'=>$type['id']));?>" class="am-btn am-btn-default"><span class="am-icon-plus"></span> 新增</a>
        ...
        <div class="am-u-sm-12">
          <form class="am-form">
            <table class="am-table am-table-striped am-table-hover table-main am-table-bordered">
              <thead>
              <tr>
                 <th class="table-check"><input type="checkbox" /></th><th class="table-id">ID</th><th class="table-author am-hide-sm-only">分类名称</th><th class="table-num">排序数字</th><th class="table-time">修改时间</th><th class="table-set">操作</th>
              </tr>
              </thead>
              <tbody>
			  <?php if(is_array($data)): foreach($data as $key=>$article): ?><tr>
                <td><input type="checkbox" /></td>
                <td><?php echo ($article['id']); ?></td>
                <td class="am-hide-sm-only"><?php echo ($article['arttype']); ?></td>
				<td><?php echo ($article['artnum']); ?></td>
				<td><?php echo (date('Y-m-d H:i',$article['time'])); ?></td>
                <td>
                  <div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                      <a href="<?php echo U('Type/editType',array('id'=>$article['id']));?>" class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span> 编辑</a>
                      <a href="<?php echo U('Type/delete',array('id'=>$article['id']));?>"class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only"><span class="am-icon-trash-o"></span> 删除</a>
                    </div>
                  </div>
                </td>
