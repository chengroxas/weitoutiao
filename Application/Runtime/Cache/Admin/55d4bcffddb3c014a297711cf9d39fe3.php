  ...
  <div class="admin-content">
    <div class="admin-content-body">
      <div class="am-cf am-padding am-padding-bottom-0">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">添加管理员</strong> / <small>Personal information</small></div>
      </div>
      ...
      <div class="am-g">
        ...
        <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
          <form action="<?php echo U('Manage/addManager');?>" method="post" class="am-form am-form-horizontal">
            <div class="am-form-group">
              <label for="manager-name" class="am-u-sm-3 am-form-label">管理员</label>
              <div class="am-u-sm-9">
                <input type="text" id="manager-name" name="manager" placeholder="管理员">
                <small>输入管理员的用户名</small>
              </div>
            </div>

            <div class="am-form-group">
              <label for="manager-pwd"  class="am-u-sm-3 am-form-label">密码</label>
              <div class="am-u-sm-9">
                <input type="password" name="pwd" id="manager-pwd" placeholder="输入管理员密码">
                <small>输入管理员密码</small>
              </div>
            </div>

            <div class="am-form-group">
              <label for="manager-repwd" class="am-u-sm-3 am-form-label">确认密码</label>
              <div class="am-u-sm-9">
                <input type="password" name="repwd" id="manager-repwd" placeholder="请确认密码">
              </div>
            </div>
            </div>
			<input type="submit" name="btn" value="添加管理员"/>
            <div class="am-form-group">
