        ...
        <div class="am-u-sm-12 am-u-md-6">
          <div class="am-btn-toolbar">
            <div class="am-btn-group am-btn-group-xs">
              <a href="<?php echo U('Article/index');?>" class="am-btn am-btn-default"><span class="am-icon-plus"></span> 新增</a>
        ...
        <div class="am-u-sm-12">
          <form class="am-form">
            <table class="am-table am-table-striped am-table-hover table-main am-table-bordered">
              ...
              <tbody>
			  <?php if(is_array($data)): foreach($data as $key=>$log): ?><tr>
                <td><input type="checkbox" /></td>
                <td><?php echo ($log['id']); ?></td>
                <td><?php echo ($log['typename']); ?></td>
                <td><img class="am-center" src="<?php echo str_replace('size','small',$log['imgsrc']);?>" /></td>
                <td class="am-hide-sm-only"><?php echo ($log['title']); ?></td>
				<td><?php echo ($log['author']); ?></td>
				<td><?php echo (date('Y-m-d H:i',$log['time'])); ?></td>
                <td>
                  <div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
					  <a href="<?php echo U('Article/loop',array('id'=>$log['id']));?>" class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span>加入轮播</a>
                      <a href="<?php echo U('Article/index',array('id'=>$log['id']));?>" class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span> 编辑</a>
                      <a href="<?php echo U('Article/delete',array('id'=>$log['id']));?>" class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only"><span class="am-icon-trash-o"></span> 删除</a>
                    </div>
                  </div>
                </td>
