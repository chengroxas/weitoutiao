  ...
  <div class="admin-content">
    <div class="admin-content-body">
      <div class="am-cf am-padding am-padding-bottom-0">
        <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">编辑轮播</strong> / <small>Personal information</small></div>
      </div>
      ...
      <div class="am-g">
        ...
        <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
          <form action="<?php echo U('Article/modifyLoop',array('id'=>$data['id']));?>" enctype="multipart/form-data" method="post" class="am-form am-form-horizontal">
            <div class="am-form-group">
              <label for="article-num"  class="am-u-sm-3 am-form-label">排序数字</label>
              <div class="am-u-sm-9">
                <input type="text" name="no" id="artNum" value="<?php echo ($data['no']); ?>" placeholder="排序数字">
                <small>输入排序数字</small>
              </div>
            </div>
            
			 <div class="am-form-group am-form-file">
				<label for="introduce"  class="am-u-sm-3 am-form-label">上传文件</label>
				<div class="am-u-sm-9">
			...
			<input class="am-btn am-btn-primary" type="submit" name="btn" value="修改"/>
            <div class="am-form-group">
    ...
    if (input.files && input.files[0]) {
        if(input.files[0].size<2097152) {
            ...
            reader.onload = function (e) {
				...
				$.post('/admin/Article/imgSave',data, function(ret){
					if(ret!=0){
